...
def window_addSubject():
    ...
    windowAddSubject.config(bg="#EFF193")
    lbl = tk.Label(windowAddSubject, text="Agregar Curso", font=("Arial", 12, BOLD), bg="#F7DC46")
    ...
    lbl = tk.Label(windowAddSubject, text="Código", font=("Arial", 10), bg="#F7DC46")
    lbl.place(x = 60, y = 80)
    lbl1 = tk.Label(windowAddSubject, text="Nombre", font=("Arial", 10), bg="#F7DC46")
    lbl1.place(x = 60, y = 120)
    lbl2 = tk.Label(windowAddSubject, text="Pre-requisitos", font=("Arial", 10), bg="#F7DC46")
    lbl2.place(x = 60, y = 160)
    lbl3 = tk.Label(windowAddSubject, text="Obligatorio", font=("Arial", 10), bg="#F7DC46")
    lbl3.place(x = 60, y = 200)
    lbl4 = tk.Label(windowAddSubject, text="Semestre", font=("Arial", 10), bg="#F7DC46")
    lbl4.place(x = 60, y = 240)
    lbl5 = tk.Label(windowAddSubject, text="Créditos", font=("Arial", 10), bg="#F7DC46")
    lbl5.place(x = 60, y = 280)
    lbl6 = tk.Label(windowAddSubject, text="Estado", font=("Arial", 10), bg="#F7DC46")
    ...
    btn = tk.Button(windowAddSubject, text="Agregar Curso", command=addS, font=("Arial", 10), bg="#C4CBCB")
...
def window_deleteSubject():
    ...
    windowDeleteSubject.config(bg="#EFF193")
    code = StringVar()
    ...
    btn = tk.Button(windowDeleteSubject, text="Eliminar Curso", command=delete, bg="#C4CBCB")
...
def window_showSubject():
    ...
    lbl = tk.Label(windowShowSubject, text="Código", font=("Arial", 10), bg="#F7DC46")
    lbl.place(x = 60, y = 80)
    lbl1 = tk.Label(windowShowSubject, text="Nombre", font=("Arial", 10), bg="#F7DC46")
    lbl1.place(x = 60, y = 120)
    lbl2 = tk.Label(windowShowSubject, text="Pre-requisitos", font=("Arial", 10), bg="#F7DC46")
    lbl2.place(x = 60, y = 160)
    lbl3 = tk.Label(windowShowSubject, text="Obligatorio", font=("Arial", 10), bg="#F7DC46")
    lbl3.place(x = 60, y = 200)
    lbl4 = tk.Label(windowShowSubject, text="Semestre", font=("Arial", 10), bg="#F7DC46")
    lbl4.place(x = 60, y = 240)
    lbl5 = tk.Label(windowShowSubject, text="Créditos", font=("Arial", 10), bg="#F7DC46")
    lbl5.place(x = 60, y = 280)
    lbl6 = tk.Label(windowShowSubject, text="Estado", font=("Arial", 10), bg="#F7DC46")
    lbl6.place(x = 60, y = 320)
    ...
    btn1 = tk.Button(windowShowSubject, text="Buscar", command=search, font=("Arial", 10), bg="#C4CBCB")
    btn1.place(x = 380, y = 10, width=100, height=30)
    btn2 = tk.Button(windowShowSubject, text="Borrar", command=cleanEntry, font=("Arial", 10), bg="#C4CBCB")
...
def window_editSubject():
    ...
    windowEditSubject.config(bg="#EFF193")
    code = StringVar()
    name = StringVar()
    prerequisite = StringVar()
    semester = StringVar()
    ...
    lbl = tk.Label(windowEditSubject, text="Código", font=("Arial", 10), bg="#F7DC46")
    lbl.place(x = 60, y = 80)
    lbl1 = tk.Label(windowEditSubject, text="Nombre", font=("Arial", 10), bg="#F7DC46")
    lbl1.place(x = 60, y = 120)
    lbl2 = tk.Label(windowEditSubject, text="Pre-requisitos", font=("Arial", 10), bg="#F7DC46")
    lbl2.place(x = 60, y = 160)
    lbl3 = tk.Label(windowEditSubject, text="Obligatorio", font=("Arial", 10), bg="#F7DC46")
    lbl3.place(x = 60, y = 200)
    lbl4 = tk.Label(windowEditSubject, text="Semestre", font=("Arial", 10), bg="#F7DC46")
    lbl4.place(x = 60, y = 240)
    lbl5 = tk.Label(windowEditSubject, text="Créditos", font=("Arial", 10), bg="#F7DC46")
    lbl5.place(x = 60, y = 280)
    lbl6 = tk.Label(windowEditSubject, text="Estado", font=("Arial", 10), bg="#F7DC46")
    lbl6.place(x = 60, y = 320)
    ...
    btn1 = tk.Button(windowEditSubject, text="Editar", command=edit, font=("Arial", 10), bg="#C4CBCB")
...
def window_manageSubjects():
    ...
    btn1 = tk.Button(windowManageSubjects, text="Mostrar Cursos", command=window_showSubject, font=("Arial", 10), bg="#C4CBCB")
    btn1.place(x=180, y=140, width=150, height=50)
    btn2 = tk.Button(windowManageSubjects, text="Agregar Cursos", command=window_addSubject, font=("Arial", 10), bg="#C4CBCB")
    btn2.place(x=180, y=200, width=150, height=50)
    btn3 = tk.Button(windowManageSubjects, text="Editar Cursos", command=window_editSubject, font=("Arial", 10), bg="#C4CBCB")
...
def window_credits():
    ...
    lblApproved_title = tk.Label(windowCredits, text="Créditos Aprobados", font=("Arial", 10), bg="#F7DC46")
    lblApproved_title.place(x= 175, y=50)
    approvedCredits = StringVar()
    approvedCredits.set(str(fn.coursesCounter("0")))
    lblApproved = tk.Label(windowCredits, textvariable=approvedCredits, font=("Arial", 10), bg="#F7DC46")
    lblApproved.place(x=325, y=50)
    
    lblCursing_title = tk.Label(windowCredits, text="Créditos Cursando", font=("Arial", 10), bg="#F7DC46")
    lblCursing_title.place(x= 175, y=80)
    cursingCredits = StringVar()
    cursingCredits.set(str(fn.coursesCounter("1")))
    lblCursing = tk.Label(windowCredits, textvariable=cursingCredits, font=("Arial", 10), bg="#F7DC46")
    lblCursing.place(x=325, y=80)

    lblCursingP_title = tk.Label(windowCredits, text="Créditos Pendientes", font=("Arial", 10), bg="#F7DC46")
    lblCursingP_title.place(x= 175, y=110)
    cursingPCredits = StringVar()
    cursingPCredits.set(str(fn.coursesPCounter("-1", "1")))
    lblCursingP = tk.Label(windowCredits, textvariable=cursingPCredits, font=("Arial", 10), bg="#F7DC46")
    lblCursingP.place(x=325, y=110)
    
    #creditos hasta semestre N
    lbl = tk.Label(windowCredits, text="Créditos Obligatorios hasta Semestre N", font=("Arial", 10, BOLD), bg="#F7DC46")
    ...
    bc = tk.Button(windowCredits, text="Contar", command=creditsUntilSemester, bg="#C4CBCB")
    bc.place(x= 260, y= 185, width=120, height=30)
    lbl2 = tk.Label(windowCredits, text="Resultado:", font=("Arial", 10), bg="#F7DC46")
    lbl2.place(x= 210, y= 225)
    lbl3 = tk.Label(windowCredits, textvariable=credP, font=("Arial", 10), bg="#F7DC46")
    lbl3.place(x= 280, y= 225)  
      
    #creditos en semestre N
    lbl = tk.Label(windowCredits, text="Créditos del Semestre N", font=("Arial", 10, BOLD), bg="#F7DC46")
    ...
    T1 = tk.Label(windowCredits, text="Resultado créditos aprobados:", font=("Arial", 10), bg="#F7DC46")
    T1.place(x= 130, y= 335)
    T2 = tk.Label(windowCredits, text="Resultado créditos asignados:", font=("Arial", 10), bg="#F7DC46")
    T2.place(x= 130, y= 358)
    T2 = tk.Label(windowCredits, text="Resultado créditos pendientes:", font=("Arial", 10), bg="#F7DC46")
    T2.place(x= 130, y= 380)
    
    lbl7 = tk.Label(windowCredits, textvariable=credA, font=("Arial", 10), bg="#F7DC46")
    lbl7.place(x= 320, y= 335)
    lbl8 = tk.Label(windowCredits, textvariable=credC, font=("Arial", 10), bg="#F7DC46")
...
window.config(bg="#EFF193")
#window.eval('tk::PlaceWindow . center')
lbl1 = tk.Wm.title(window, "Gestión de Cursos Ingeniería")
lbl2 = tk.Label(window, text="Nombre del Curso: Lab. Lenguajes Formales y de Programación", font=("Arial", 12, BOLD), bg="#F7DC46")
lbl2.place(x=5,y=40)
lbl3 = tk.Label(window, text="Nombre del Estudiante: Aldo Saúl Vásquez Moreira", font=("Arial", 12, BOLD), bg="#F7DC46")
lbl3.place(x=40,y=60)
lbl4 = tk.Label(window, text="Carné del Estudiante: 202109754", font=("Arial", 12, BOLD), bg="#F7DC46")
lbl4.place(x=130, y=80)

#botones de menú principal
b = tk.Button(window, text="Cargar Archivo", command=window_openFile, font=("Arial", 10), bg="#C4CBCB")
b.place(x=180, y=120, width=150, height=50)
b1 = tk.Button(window, text="Gestionar Cursos", command=window_manageSubjects, font=("Arial", 10), bg="#C4CBCB")
b1.place(x=180, y=180, width=150, height=50)
b2 = tk.Button(window, text="Conteo de Créditos", command=window_credits, font=("Arial", 10), bg="#C4CBCB")
b2.place(x=180, y=240, width=150, height=50)
b3 = tk.Button(window, text="Salir", command=window.destroy, font=("Arial", 10), bg="#C4CBCB")
